package com.javasm.util.redis.service;
...
import com.javasm.util.RedisContants;
...
public class RedisService {
    ...
    public String set(String key, String value) {  
    	ShardedJedis shardedJedis = RedisBucket.getInstance().getShardPool(RedisContants.RedisNameSimple).getResource();
    	String result = null;
     ...
     * 
      * @Title: rpush 
      * @Description: 在指定Key所关联的List Value的尾部插入参数中给出的所有Values。如果该Key不存在，该命令将在插入之前创建一个与该Key关联的空链表，之后再将数据从链表的尾部插入。如果该键的Value不是链表类型，该命令将返回相关的错误信息。
      * @param @param key
      * @param @param string
      * @param @return
      * @return Long
     ...
     * 
      * @Title: lpush 
      * @Description: 在指定Key所关联的List Value的头部插入参数中给出的所有Values。如果该Key不存在，该命令将在插入之前创建一个与该Key关联的空链表，之后再将数据从链表的头部插入。如果该键的Value不是链表类型，该命令将返回相关的错误信息。
      * @param @param key
      * @param @param string
      * @param @return
      * @return Long
